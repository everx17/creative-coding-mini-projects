class AsteroidSystem
{
  ...
  spawn()
  { // spawn rate it doubled at score 100, tripled at score 200 etc.
    if (random(1) < (0.01 + score/10000))
    { // asteroid min and max speeds are doubled at score 100, tripled at 200 etc.
      this.accelerations.push(new createVector(0, (1 + score/100)*random(0.1, 1)));
