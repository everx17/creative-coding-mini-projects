	...
	this.selectVisual = function(visName)
	{
		for(var i = 0; i < this.visuals.length; i++)
		{
			if(visName == this.visuals[i].name)
			{
				...
				// bugfix: when switching to a vis with an onResize method,
				//         call this method, in case window size has changed
				//         while the vis was inactive (i.e. it wasn't notified)
